...
Ce document décrit le processus de déploiement du portfolio statique sur un serveur utilisant Nginx comme serveur web. Le site est accessible via l'adresse IP `192.168.2.50` sur le port `3000`.
...
**Flux de requête** :
1. L'utilisateur accède à `http://192.168.2.50:3000`
...
server {
    ...
    server_name 192.168.2.50 cedric.littlenuage.com www.cedric.littlenuage.com;
...
# Test avec l'IP
curl http://192.168.2.50:3000
```

Ouvrez votre navigateur et accédez à : **http://192.168.2.50:3000**
...
- [ ] Nginx redémarré
- [ ] Site accessible via `http://192.168.2.50:3000`
