...
<div style="text-align: center; margin: 30px 0;">
  <img src="/assets/images/courses/S7/poo-cpp/heritage-polymorphisme.svg" alt="Héritage et polymorphisme C++" style="max-width: 550px; border: 1px solid #ddd; padding: 15px; border-radius: 8px; background: white;" />
  <p style="font-style: italic; color: #666; margin-top: 10px;">Figure : Héritage et polymorphisme en C++ - Classe de base Animal et classes dérivées</p>
</div>
