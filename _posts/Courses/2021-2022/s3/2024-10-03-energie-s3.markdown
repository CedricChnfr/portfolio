...
<div class="pdf-container">
  <div class="pdf-viewer">
    ...
    <div class="pdf-item">
      <h4>Polycopie de Cours Energie S3</h4>
      <p>Support de cours complet : conversion d'energie, machines electriques, electronique de puissance et energies renouvelables.</p>
      <embed src="/cours-pdf/S3/Energie/Poly_Cours_S3_2020_-_2021.pdf" type="application/pdf" width="100%" height="800px" />
      <p style="text-align: center; margin-top: 10px;">
        <a href="/cours-pdf/S3/Energie/Poly_Cours_S3_2020_-_2021.pdf" target="_blank" style="color: #2a7ae2; text-decoration: none; font-weight: 600;">Telecharger le PDF</a>
      </p>
    </div>
