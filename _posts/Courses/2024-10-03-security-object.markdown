...
## Course: Security for Connected Objects

## PART A: GENERALITIES

### Presentation
The course "Security for Connected Objects" is taught by Eric Alata and Vincent Migliore. This course is an introduction to software and hardware security specifically targeted for IoT needs. It consists of theoretical classes to explain the concepts behind various topics, followed by one or two labs per topic. This structure allowed us to explore a wide range of topics related to security.
...
- **Theoretical Knowledge**: Gained insights into security measures for IoT devices.
- **Operational Skills**: Developed skills in implementing and configuring security protocols.
- **Analytical Skills**: Learned to assess the suitability of different security measures based on IoT requirements.
- **Impact Understanding**: Understood the impact of security vulnerabilities on IoT devices.
- **Development Phases**: Understood the major development phases for securing IoT communications.
